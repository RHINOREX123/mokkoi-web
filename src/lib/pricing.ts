...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      '250 credits / month',
      '~12 full apps or 50 new screens',
      'Everything in Hobby',
      'MCP API access',
  ...
  },
  {
    ...
    overage: '$0.10 / credit',
    features: [
      '750 pooled credits / seat / month',
      '~37 full apps or 150 new screens per seat',
      'Everything in Pro',
